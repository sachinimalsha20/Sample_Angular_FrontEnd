...
@Component({
  selector: 'app-create-new-indicator',
  templateUrl: './create-new-indicator.component.html',
  styleUrls: ['./create-new-indicator.component.css']
})
export class CreateNewIndicatorComponent implements OnInit {
  ...
  saveProject() {
    this.indicator.indicatorClassification = this.classification;
    this.indicatorService.addProject(this.indicator).subscribe(data => {
        console.log(data);
      },
